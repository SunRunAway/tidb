...
var (
	...
	ErrInvalidHashKeyFlag = dbterror.NewStd(terror.ClassStructure, mysql.ErrInvalidHashKeyFlag)
	// ErrInvalidListIndex used by structure
	ErrInvalidListIndex = dbterror.NewStd(terror.ClassStructure, mysql.ErrInvalidListIndex)
	// ErrInvalidListMetaData used by structure
	ErrInvalidListMetaData = dbterror.NewStd(terror.ClassStructure, mysql.ErrInvalidListMetaData)
	// ErrWriteOnSnapshot used by structure
	ErrWriteOnSnapshot = dbterror.NewStd(terror.ClassStructure, mysql.ErrWriteOnSnapshot)
)
